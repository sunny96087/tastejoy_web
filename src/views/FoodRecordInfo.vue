    ...
    <div class="w-full max-w-lg h-screen bg-custom-color p-4 rounded-2xl overflow-auto">
      ...
      <form>
        ...
        <div class="flex justify-end">
          <button class="w-1/5 px-4 py-2 mr-2 border rounded-2xl text-[#BDB890] flex justify-center items-center hover:bg-[#6F6D55]">
            刪除
          ...
          <button type="cancel" class="w-1/5 px-4 py-2 mr-2 border rounded-2xl text-[#BDB890] flex justify-center items-center hover:bg-[#6F6D55]">
            導航
